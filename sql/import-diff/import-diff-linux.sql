...
IMPORT FROM ../import_diff/tooHotels.csv    OF DEL MODIFIED BY norowwarnings METHOD P ( 1, 33 ) COMMITCOUNT 10000  REPLACE INTO TOOHOTEL2 ( HOTELKEY, TOCODE ) @
IMPORT FROM ../import_diff/tooRooms.csv     OF DEL                           METHOD P ( 2, 29 ) COMMITCOUNT 10000  REPLACE INTO TOOROOMS2 ( ROOMKEY, TOCODE ) @
IMPORT FROM ../import_diff/tooMisc.csv      OF DEL                           METHOD P ( 1, 2 )  COMMITCOUNT 10000  REPLACE INTO TOOMISC2  ( MISCKEY, TOCODE ) @
...
delete from TOOONETIME where (TOOONETIME.ITEMKEY, TOOONETIME.TOCODE)                      in (select TOOMISC2.MISCKEY, TOOMISC2.TOCODE from TOOMISC2)      and TOOONETIME.ITEMTYPE        ='M' @
...
IMPORT FROM ../import_diff/tooRooms.csv           OF DEL                                              COMMITCOUNT 10000   INSERT INTO TOOROOMS @
IMPORT FROM ../import_diff/tooMisc.csv            OF DEL                                              COMMITCOUNT 10000   INSERT INTO TOOMISC @
IMPORT FROM ../import_diff/tooMiscHotel.csv       OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOMISCHOTEL @
IMPORT FROM ../import_diff/tooMiscText.csv        OF DEL MODIFIED BY identitymissing delprioritychar  COMMITCOUNT 10000   INSERT INTO TOOMISCTEXT @
IMPORT FROM ../import_diff/tooDescriptions.csv    OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOODESCRIPTIONS @
IMPORT FROM ../import_diff/tooPerDayPrices.csv    OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOPERDAYPRICE @
IMPORT FROM ../import_diff/tooAddPerDayPrices.csv OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOADDPERDAYPRICE @
IMPORT FROM ../import_diff/tooOneTimes.csv        OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOONETIME @
IMPORT FROM ../import_diff/tooSpecialOffers.csv   OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOSPECIALOFFERS @
IMPORT FROM ../import_diff/tooEarlyBookings.csv   OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOEARLYBOOKINGS @
IMPORT FROM ../import_diff/tooAllotments.csv      OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOALLOTMENTS @
IMPORT FROM ../import_diff/tooCancellations.csv   OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOCANCELLATIONS @
IMPORT FROM ../import_diff/tooItemInfos.csv       OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOITEMINFOS @
IMPORT FROM ../import_diff/tooPeriodPrices.csv    OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOPERIODPRICE @
IMPORT FROM ../import_diff/tooAddPeriodPrices.csv OF DEL MODIFIED BY identitymissing                  COMMITCOUNT 10000   INSERT INTO TOOADDPERIODPRICE @
IMPORT FROM ../import_diff/tooHotels.csv          OF DEL MODIFIED BY norowwarnings                    COMMITCOUNT 10000   INSERT INTO TOOHOTEL @
