...
drop function func_all_flight_tbl @

CREATE FUNCTION func_all_flight_tbl (
  p_tocode VARCHAR(5) DEFAULT ''
  ,p_itemkey VARCHAR(20) DEFAULT ''
  ,p_startdate DATE DEFAULT NULL
  ,p_adultnr INTEGER DEFAULT 0
...
BEGIN
  ...
  SELECT p_adultnr
    ...
    ,descid
    ,p_seq
    ,tooperdayflightprice.pricetype
  ...
  WHERE (
    ...
    AND tooperdayflightprice.day = p_startdate
    AND childidxnr = 0
  ...
  WHERE (
    ...
    AND bd IS NOT NULL;
  -- PerDayFlightPrice: End

END
@


drop function func_all_ot_tbl @

CREATE FUNCTION func_all_ot_tbl (
  p_tocode VARCHAR(5) DEFAULT ''
  ,p_itemkey VARCHAR(20) DEFAULT ''
  ,p_itemtype VARCHAR(1) DEFAULT ''
  ,p_startdate DATE DEFAULT NULL
...
drop function func_all_pdp_tbl @

CREATE FUNCTION func_all_pdp_tbl (
  p_tocode VARCHAR(5) DEFAULT ''
  ,p_itemkey VARCHAR(20) DEFAULT ''
  ,p_itemtype VARCHAR(1) DEFAULT ''
  ,p_startdate DATE DEFAULT NULL
...
drop function func_all_pdp_pp_app_tbl @

CREATE FUNCTION func_all_pdp_pp_app_tbl (
  p_tocode VARCHAR(5) DEFAULT ''
  ,p_itemkey VARCHAR(20) DEFAULT ''
  ,p_itemtype VARCHAR(1) DEFAULT ''
  ,p_startdate DATE DEFAULT NULL
