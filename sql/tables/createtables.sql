...
(
  ...
  ,roomtypede varchar(180) with default ''
  ,roomtypeen varchar(180) with default ''
  ,roomtypefr varchar(180) with default ''
  ,roomtypeit varchar(180) with default ''
  ,descriptionde varchar(250) with default ''
  ,descriptionen varchar(250) with default ''
  ,descriptionfr varchar(250) with default ''
  ,descriptionit varchar(250) with default ''
  ,mealcode varchar(50) with default ''
  ,tourbomealcode varchar(5) with default ''
  ,mealdescriptionde varchar(150) with default ''
  ,mealdescriptionen varchar(150) with default ''
  ,mealdescriptionfr varchar(150) with default ''
  ,mealdescriptionit varchar(150) with default ''
