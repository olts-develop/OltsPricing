...
drop index TOO__ARRANGEMENT2_IDX1 @
...
create index TOO_PDP_IDX1 ON TOOPERDAYPRICE ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_APDP_IDX1 ON TOOADDPERDAYPRICE ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_APDP_IDX2 ON TOOADDPERDAYPRICE ( itemkey, tocode, day, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_OT_IDX1 ON TOOONETIME ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_OT_IDX2 ON TOOONETIME ( itemkey, tocode, datefrom, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_SO_IDX1 ON TOOSPECIALOFFERS ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_SO_IDX2 ON TOOSPECIALOFFERS ( itemkey, tocode, datefrom, dateto, childchildnr, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_EB_IDX1 ON TOOEARLYBOOKINGS ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_EB_IDX2 ON TOOEARLYBOOKINGS ( itemkey, tocode, datefrom, dateto, daysbeforedeparturefrom, daysbeforedepartureto, datebeforedeparturefrom, datebeforedepartureto, fromday, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_PP_IDX1 ON TOOPERIODPRICE ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_PP_IDX2 ON TOOPERIODPRICE ( itemkey, tocode, datefrom, dateto, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_APP_IDX1 ON TOOADDPERIODPRICE ( itemkey, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_APP_IDX2 ON TOOADDPERIODPRICE ( itemkey, tocode, datefrom, dateto, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
