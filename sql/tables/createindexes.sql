...
drop index TOO_PDFP_IDX1 @
drop index TOO_PDFP_IDX2 @
drop index TOO_PDFP_IDX3 @
drop index TOO_PDFP_IDX4 @
drop index TOO_PDFP_IDX5 @
...
create index TOO_PDFP_IDX1 ON TOOPERDAYFLIGHTPRICE ( itemkey, tocode, currency ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_PDFP_IDX2 ON TOOPERDAYFLIGHTPRICE ( itemkey, tocode, day, childidxnr ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_PDFP_IDX3 ON TOOPERDAYFLIGHTPRICE ( itemkey ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_PDFP_IDX4 ON TOOPERDAYFLIGHTPRICE ( p_seq ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
create index TOO_PDFP_IDX5 ON TOOPERDAYFLIGHTPRICE ( itemkey, tocode, day, childidxnr, agefrom, ageto, currency ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_ALLOT_IDX5 ON TOOALLOTMENTS ( itemkey, allotdate, tocode, itemtype ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO   @
...
create index TOO_FLIGHT_IDX4 ON TOOFLIGHT ( FLIGHTKEY, MULTILEG, TOCODE ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO  @
...
create index TOO_FLIGHTLEG_IDX5 ON TOOFLIGHTLEG ( FLIGHTKEY, TOCODE, LEGKEY, POS ) ALLOW REVERSE SCANS PAGE SPLIT SYMMETRIC COMPRESS NO  @
